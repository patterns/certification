...
const char* ei_classifier_inferencing_categories[] = { "alarm", "normal" };

ei_dsp_named_axis_t ei_dsp_config_47_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_47_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_47_axes[] = { 0 };
const uint32_t ei_dsp_config_47_axes_size = 1;
ei_dsp_config_mfe_t ei_dsp_config_47 = {
    47, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_47_named_axes, // named axes
    ei_dsp_config_47_named_axes_size, // size of the named axes array
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 47
        ...
        (void*)&ei_dsp_config_47, // pointer to config struct
        ei_dsp_config_47_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_47_axes_size, // number of axes
        1, // version
...
const uint32_t ei_learning_block_51_inputs[1] = { 47 };
...
const ei_impulse_t impulse_709802_0 = {
    .project_id = 709802,
    .project_owner = "hsin2025",
    .project_name = "EEP564 Project-Audio Classification - Home Security",
    .impulse_id = 2,
    .impulse_name = "Impulse #2",
    .deploy_version = 13,

    .nn_input_frame_size = 4018,
...
ei_impulse_handle_t impulse_handle_709802_0 = ei_impulse_handle_t( &impulse_709802_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_709802_0;
